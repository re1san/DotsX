...
static const char *fonts[] = {
    ...
    "Noto Sans Mono CJK JP:size=11:style=Regular",
    "Wings:size=16:style=Regular"};

static const char dmenufont[] = "Iosevka Nerd Font:size=12";
static const char col_back[] = "#121111";
static const char col_back_alt[] = "#191919";
...
static const char *colors[][3] = {
    ...
    [SchemeBtn] = {col_blue, col_back_alt, col_gray2},
    [SchemeLt] = {col_gray4, col_back, col_gray2},
    [SchemeSel] = {col_gray4, col_blue, col_blue},
};
static const char *tagsel[][2] = {
    {col_blue, col_back}, {col_magenta, col_back}, {col_yellow, col_back},
    {col_green, col_back}, {col_red, col_back}, {col_cyan, col_back},
};
...
static const StatusCmd statuscmds[] = {
    ...
    {"~/.local/bin/statusbar/system-settings", 8},
    {"~/.local/bin/statusbar/profile", 9},
};

static const char *statuscmd[] = {"/bin/bash", "-c", "NULL", NULL};

/* tagging */
static char *tags[] = {"cmd", "www", "dev", "chat", "sys", "mus"};
