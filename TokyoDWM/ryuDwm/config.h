...
static Key keys[] = {
	...
	{ MODKEY, 			XK_e, 	       spawn,                  SHCMD("~/.local/bin/dashboard")}, /* Launch eww panel */
	...
	{ MODKEY|ShiftMask|ControlMask,             XK_q,          spawn,                  SHCMD("~/.config/rofi/powermenu/powermenu.sh")}, /* rofi powermenu */
	{ MODKEY,                       XK_F1,         spawn,                  {.v = lock } }, /* betterlockscreen */
